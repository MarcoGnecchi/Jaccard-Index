...
public class JaccardIndexServiceTest {
    ...
    public void shouldReturn1WhenTheContentMatch() {
        String text1 = "test";
        String text2 = "test";
        assertThat(jaccardIndexService.perform(text1,text2), is(equalTo(1)));
    }
    ...
    public void shouldReturn0WhenThereAreNoCommonWords(){
        ...
        assertThat(jaccardIndexService.perform(text1,text2), is(equalTo(0)));
    }

    @Test
    public void shouldDetectCommonWords(){
        //2 common words out of 6, 2 / 6 = 1/3 = 0.3333
        String text1 = "this is an apple";
        String text2 = "this is a book";
        assertThat(jaccardIndexService.perform(text1,text2), is(equalTo(0.333)));
    }
}